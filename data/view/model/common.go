...
import (
	...
	"github.com/icetech233/ice-gormt/data/config"
	"github.com/icetech233/ice-gormt/data/view/cnf"
	"github.com/icetech233/ice-gormt/data/view/genfunc"
...
func getTypeName(name string, isNull bool) string {
	...
	panic(fmt.Sprintf("type (%v) not match in any way.maybe need to add on (https://github.com/icetech233/ice-gormt/blob/master/data/view/cnf/def.go)", name))
}
